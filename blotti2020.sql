...
--
-- Estrutura da tabela `catprodutos`
--
...
--
-- Limitadores para a tabela `catprodutos`
--
ALTER TABLE `catprodutos`
  ADD CONSTRAINT `catprodutos_ibfk_1` FOREIGN KEY (`seriados`) REFERENCES `seriados` (`cod`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
